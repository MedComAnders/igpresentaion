...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Communication/f:payload">
      <sch:assert test="count(f:extension[@url = 'http://medcomfhir.dk/fhir/core/1.0/StructureDefinition/medcom-core-datetime-extension']) &gt;= 1">extension with URL = 'http://medcomfhir.dk/fhir/core/1.0/StructureDefinition/medcom-core-datetime-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://medcomfhir.dk/fhir/core/1.0/StructureDefinition/medcom-core-datetime-extension']) &lt;= 1">extension with URL = 'http://medcomfhir.dk/fhir/core/1.0/StructureDefinition/medcom-core-datetime-extension': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://medcomfhir.dk/fhir/core/1.0/StructureDefinition/medcom-core-author-extension']) &gt;= 1">extension with URL = 'http://medcomfhir.dk/fhir/core/1.0/StructureDefinition/medcom-core-author-extension': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://medcomfhir.dk/fhir/core/1.0/StructureDefinition/medcom-core-author-extension']) &lt;= 1">extension with URL = 'http://medcomfhir.dk/fhir/core/1.0/StructureDefinition/medcom-core-author-extension': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
